...
/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║  CleanShop B2B — МАСТЕР-МИГРАЦИЯ                                ║
 * ║  Все 8 таблиц + индексы + триггеры + view за один запуск        ║
 * ║                                                                  ║
 * ║  Порядок создания:                                               ║
 * ║   1. Вспомогательная функция updated_at                         ║
 * ║   2. companies                                                   ║
 * ║   3. users                                                       ║
 * ║   4. products                                                    ║
 * ║   5. orders                                                      ║
 * ║   6. trucks                                                      ║
 * ║   7. pallets + pallet_items                                      ║
 * ║   8. invoices + invoice_deliveries                               ║
 * ║   9. chat_messages                                               ║
 * ║  10. views + seed-данные                                         ║
 * ╚══════════════════════════════════════════════════════════════════╝
 *
...
export class InitAllTables1700000000000 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // ──────────────────────────────────────────────────────────────────
    // 0. Триггерная функция updated_at (общая для всех таблиц)
    // ──────────────────────────────────────────────────────────────────
    ...
    // Сводка по фурам — используется в планировщике
    await queryRunner.query(`
    ...
    // Дашборд клиента — статистика одним запросом
    await queryRunner.query(`
    ...
    // ──────────────────────────────────────────────────────────────────
    // 11. SEED — тестовые данные для dev
    // ──────────────────────────────────────────────────────────────────
    ...
    // Тестовый клиент (telegram_id=123456789 — используй в ngrok-тестах)
    await queryRunner.query(`
      INSERT INTO "users"
  ...
  // ════════════════════════════════════════════════════════════════════
  // DOWN — полный откат в обратном порядке
  // ════════════════════════════════════════════════════════════════════
